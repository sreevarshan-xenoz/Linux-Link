...
- Next: R4 E2 (phone mic → desktop PipeWire sink, reverse audio — note `core/src/streaming/audio_capture.rs` carries user WIP, stage carefully). Parked: R2#3 remainder (in-process VAAPI/NVENC — untestable on this box).
