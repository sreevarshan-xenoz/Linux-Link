...
- Next: R4 E3 (compositor-true end-to-end latency probe) per execution order. Parked: R2#3 remainder (in-process VAAPI/NVENC — untestable on this box).
