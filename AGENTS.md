...
- Next: R4 B3 (capture backend ordering + config override) per execution order. Parked: R2#3 remainder (in-process VAAPI/NVENC — untestable on this box).
