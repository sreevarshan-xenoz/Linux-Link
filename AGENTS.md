...
- Next: MediaCodec decode via JNI Surface (feed `receiveFrames` output); wire `RustCore` into Compose screens (connection, remote desktop, file browser, settings); then continue roadmap R2 items.
